...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    profile_img = models.ImageField(max_length=None , upload_to = upload_to , default = "defualt-profile_LCrqeVq.jpg")
    card_id_img =  models.ImageField(max_length=None , upload_to = upload_to,default = "defualt-profile_LCrqeVq.jpg")
    commercial_record_img = models.ImageField(max_length=None , upload_to = upload_to,default = "defualt-profile_LCrqeVq.jpg")
